...
#include "common_temp/BuffAction.hpp"
#include "common_temp/BuffMapInfo.hpp"
#include "common_temp/BuffSkillValue.hpp"
...
namespace std {
	template <>
	struct hash<vana::buff_info> {
		auto operator()(const vana::buff_info &v) const -> size_t {
