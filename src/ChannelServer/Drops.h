...
namespace Drops {
	void doDrops(int32_t playerid, int32_t mapid, int32_t droppingLevel, int32_t droppingId, Pos origin, bool explosive, bool ffa, int32_t taunt = 100, bool isSteal = false);
