...
namespace LuaExports {
	...
	auto addPlayerSignUp(lua_State *luaVm) -> lua_return_t;
	auto banInstancePlayer(lua_State *luaVm) -> lua_return_t;
	...
	auto getBannedInstancePlayerByIndex(lua_State *luaVm) -> lua_return_t;
	auto getBannedInstancePlayerCount(lua_State *luaVm) -> lua_return_t;
	auto getInstanceMax(lua_State *luaVm) -> lua_return_t;
	auto getInstancePlayerByIndex(lua_State *luaVm) -> lua_return_t;
	auto getInstancePlayerCount(lua_State *luaVm) -> lua_return_t;
	auto getInstancePlayerId(lua_State *luaVm) -> lua_return_t;
	auto getInstanceSignupCount(lua_State *luaVm) -> lua_return_t;
	auto getInstanceTime(lua_State *luaVm) -> lua_return_t;
	auto getInstanceVariable(lua_State *luaVm) -> lua_return_t;
	auto isBannedInstancePlayer(lua_State *luaVm) -> lua_return_t;
	...
	auto isPlayerSignedUp(lua_State *luaVm) -> lua_return_t;
	...
	auto removePlayerSignUp(lua_State *luaVm) -> lua_return_t;
	...
	auto setInstanceMax(lua_State *luaVm) -> lua_return_t;
	...
	auto unbanInstancePlayer(lua_State *luaVm) -> lua_return_t;
}