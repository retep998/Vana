...
namespace vana {
	...
	namespace channel_server {
		...
		namespace packets {
			...
			SPLIT_PACKET(move_summon, game_player_id player_id, summon *summon, const point &original_position, const std::list<movement_handler::movement_element> &move_path);
