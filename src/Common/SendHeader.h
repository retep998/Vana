...
#define SEND_DAMAGE_MOB_SUMMON 0xa3
#define SEND_DAMAGE_SUMMON 0xa4
#define SEND_MOVE_PLAYER 0xa7
#define SEND_DAMAGE_MOB_MELEE 0xa8
#define SEND_DAMAGE_MOB_RANGED 0xa9
#define SEND_DAMAGE_MOB_SPELL 0xaa
