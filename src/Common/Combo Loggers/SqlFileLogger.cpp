...
SqlFileLogger::SqlFileLogger(const string &filename, const string &format, const string &timeFormat, int16_t serverType, size_t bufferSize) :
...
void SqlFileLogger::log(LogTypes::LogTypes type, const string &identifier, const string &message) {
