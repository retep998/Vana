...
class SqlFileLogger : public Logger {
public:
	SqlFileLogger(const string &filename, const string &format, const string &timeFormat, int16_t serverType, size_t bufferSize = 10);
