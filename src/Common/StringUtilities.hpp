...
namespace vana {
	...
	template <typename TElement>
	auto utilities::str::delimit(const string &delimiter, const init_list<TElement> &elements) -> string {
		out_stream q{""};
	...
	template <typename TElement>
	auto utilities::str::delimit(const string &delimiter, const vector<TElement> &elements) -> string {
		out_stream q{""};
		bool add_delimiter = false;
		for (const auto &element : elements) {
			if (add_delimiter) {
	...
	inline
	auto utilities::str::to_lower(const string &s) -> string {
		string ret = s;
	...
	inline
	auto utilities::str::remove_spaces(const string &s) -> string {
		string ret = s;
