	...
	namespace data {
		...
		namespace type {
			...
			public:
				...
				auto get_item_data(const data::provider::item &provider) const -> const consume_info * const;
				auto get_skill_data(const data::provider::skill &provider) const -> const skill_level_info * const;
				auto get_mob_skill_data(const data::provider::skill &provider) const -> const mob_skill_level_info * const;
