...
auto buff_source::get_skill_data(const data::provider::skill &provider) const -> const data::type::skill_level_info * const {
	return provider.get_skill(m_skill_id, m_skill_level);
}

auto buff_source::get_mob_skill_data(const data::provider::skill &provider) const -> const data::type::mob_skill_level_info * const {
