...
--]]
-- Martin (Event Assistant)

addText("Hey, I'm #b#p9000011##k. I am waiting for my brothers... What takes them so long? I got bored now... If we do not get there on time, we might not be able to participate in the event...");
sendNext();
