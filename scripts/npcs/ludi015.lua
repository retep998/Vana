...
if isGm() or getItemAmount(4001020) > 0 then
	...
	choices = {
		makeChoice(2040024, 221024400, "100th", "100st"),
		makeChoice(2040026, 221021700, "41st"),
	};
	...
	addText("There's a rock that will enable you to teleport to " .. blue(npcRef(2040024) .. " or " .. npcRef(2040026)) .. ", but it cannot be activated without the scroll.");
	sendOk();
end