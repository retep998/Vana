...
elseif state == 1 then
	if getSelected() == 1 then
		...
		--Pirates:
		addSkillLevel(5000000, 3)
		addSkillLevel(5001001, 1)
		addSkillLevel(5001002, 1)
		addSkillLevel(5001003, 1)
		addSkillLevel(5100000, 3)
		addSkillLevel(5100001, 3)
		addSkillLevel(5101002, 1)
		addSkillLevel(5101003, 1)
		addSkillLevel(5101004, 1)
		addSkillLevel(5101005, 1)
		addSkillLevel(5101006, 3)
		addSkillLevel(5101007, 3)
		addSkillLevel(5110000, 20)
		addSkillLevel(5110001, 40)
		addSkillLevel(5111002, 30)
		addSkillLevel(5111004, 20)
		addSkillLevel(5111005, 20)
		addSkillLevel(5111006, 30)
		...
		addSkillLevel(5121008, 1)
		addSkillLevel(5121009, 20)
		addSkillLevel(5121010, 30)
		addSkillLevel(5200000, 20)
		addSkillLevel(5201001, 20)
		addSkillLevel(5201002, 20)
		addSkillLevel(5201003, 20)
		addSkillLevel(5201004, 20)
		addSkillLevel(5201005, 10)
		addSkillLevel(5201006, 20)
		addSkillLevel(5210000, 3)
		addSkillLevel(5211001, 30)
		addSkillLevel(5211002, 30)
		addSkillLevel(5211004, 30)
		addSkillLevel(5211005, 30)
		addSkillLevel(5211006, 30)
		addSkillLevel(5220001, 30)
		addSkillLevel(5220002, 20)
		addSkillLevel(5220011, 20)
		addSkillLevel(5221000, 20)
		addSkillLevel(5221003, 30)
		addSkillLevel(5221004, 30)
		addSkillLevel(5221006, 10)
		addSkillLevel(5221007, 30)
		addSkillLevel(5221008, 30)
		addSkillLevel(5221009, 20)
		addSkillLevel(5221010, 1)
