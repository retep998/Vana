...
places = {"Lith Harbor", "Perion", "Ellinia", "Kerning City"};
...
elseif state == 1 then
	if getJob() == 0 then
		addText("We have a special 90% discount for beginners. Choose your destination, for fees will change from place to place.#b\r\n#L1##bLith Harbor(80 mesos)#l\r\n#L2##bPerion(100 mesos)#l\r\n#L3##bEllinia(100 mesos)#l\r\n#L4##bKerning City(120 mesos)#l#k");
		sendSimple();
	else
		addText("Choose your destination, for fees will change from place to place.#b\r\n#L1##bLith Harbor(800 mesos)\r\n#L2##bPerion(1,000 mesos)\r\n#L3##bEllinia(1,000 mesos)\r\n#L4##bKerning City(1,200 mesos)#k");
		sendSimple();
	end
elseif state == 2 then
	where = getSelected();
