...
choices = {
	generateChoice(104000000, getPrice(800)),
	generateChoice(102000000, getPrice(1000)),
	generateChoice(101000000, getPrice(1000)),
	generateChoice(103000000, getPrice(1200)),
};

addText("Hi! I drive the " .. npcRef(1012000) .. ". ");
