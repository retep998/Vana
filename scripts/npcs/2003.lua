...
if state == 0 then
	...
	addText("#L8#What should I do to become a Magician?#l\r\n");
	addText("#L9#What should I do to become a Thief?#l\r\n");
	addText("#L10#How do I raise the character stats? (S)#l\r\n");
	addText("#L11#How do I check the items that I just picked up?#l\r\n");
	addText("#L12#How I put on an item?#l\r\n");
	addText("#L13#How do i check out the items that I'm wearing?#l\r\n");
	addText("#L14#What are skills? (K)#l\r\n");
	addText("#L15#How do I get to Victoria Island?#l\r\n");
	addText("#L16#What are mesos?#l#k");
	sendSimple();
elseif state == 1 then
	what = getSelected();
