...
if getLevel() >= 50 then
	...
	if choice == 0 then
		...
		if questState == nil then
			addText("Welcome. I'm #bRobeira#k, the chief of all magicians, always ready to offer my knowledge and guidance. ");
			...
			if ready == 0 then
				...
				addText("Remember #b#p1032001##k from Ellinia? ");
				addText("Go see him, and he'll give you the details on the first half of the test. ");
				addText("Please complete the mission, and get #b#t4031057##k from #p1032001#.");
				sendNext();
				...
				addText("I'll let #b#p1032001##k know in advance that you're making your way there, so get ready. ");
		...
		elseif questState == 1 or questState == 2 then
			if getItemAmount(4031057) > 0 then
				...
				addText("Please go see #b#p1032001##k of Ellinia, pass the test, and bring #b#t4031057##k back with you. ");
			...
			if getItemAmount(4031058) > 0 or questState == 4 then
				...
				if ready == 0 then
					...
					if getSp() > (getLevel() - 70) * 3 then
						...
						if jobType == 1 then
							addText("You're the #bMage of Fire and Poison#k from this point forward. ");
							addText("The new skill book features new and improved fire and poison based spells, and skills such as #bElement Amplification#k (improves element-based spells) and #bSpell Booster#k (improves the overall speed of your attacking spells) will enable you to attack the monsters quickly and effectively. ");
							addText("Defensive spells such as #bPartial Resistance#k (allows you to become stronger against certain element-based attacks) and #bSeal#k (seals up the monster) will help negate the one weakness of Mages: lack of HP.");
						elseif jobType == 2 then
							addText("You're the #bMage of Ice and Lightning#k from this point forward. ");
							addText("The new skill book features new and improved ice and lightning based spells, and skills such as #bElement Amplification#k (improves element-based spells) and #bSpell Booster#k (improves the overall speed of your attacking spells) will enable you to attack the monsters quickly and effectively. ");
							addText("Defensive spells such as #bPartial Resistance#k (allows you to become stronger against certain element-based attacks) and #bSeal#k (seals up the monster) will help negate the one weakness of Mages: lack of HP.");
	...
	elseif choice == 1 then
		if zakum ~= 1 then
			if job == 0 or job == 2 then
				...
				addText("So you want me to give you my permission to go on the Zakum Dungeon Quest? But you don't seem to be a magician under my jurisdiction, so please look for the Trainer that oversees your job.");
			end
		else
