	...
	if getLevel() >= 70 and jobLevel == progression_second and jobLine == line_thief then
		append(choices, makeChoiceHandler(" I want to make the 3rd job advancement", function()
			...
			if questState == nil then
				addText("Welcome. ");
				addText("I'm " .. blue("Arec") .. ", the chief of all thieves, always ready to offer my knowledge and guidance. ");
				...
				if answer == answer_no then
					...
					addText("Remember " .. blue(npcRef(1052001)) .. " from Kerning City? ");
					addText("Go see him, and he'll give you the details on the first half of the test. ");
					addText("Please complete the mission, and get " .. blue(itemRef(4031057)) .. " from " .. npcRef(1052001) .. ".");
					sendNext();
					...
					addText("I'll let " .. blue(npcRef(1052001)) .. " know in advance that you're making your way there, so get ready. ");
			...
			elseif questState == 1 or questState == 2 then
				if getItemAmount(4031057) > 0 then
					...
					addText("Please go see " .. blue(npcRef(1052001)) .. " of Perion, pass the test, and bring " .. blue(itemRef(4031057)) .. " back with you. ");
			...
			elseif questState == 3 or questState == 4 then
				if getItemAmount(4031058) > 0 or questState == 4 then
					...
					addText("Okay! Now, I'll transform you into a much more powerful thief. ");
