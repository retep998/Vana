...
if yes == 0 then
	...
	if yes == 0 then
		...
		if getMesos() < price or getBuddySlots() == 50 then
			addText("Hey... are you sure you have #b240,000 mesos#k?? If so then check and see if you have extended your buddy list to the max. Even if you pay up, the most you can have on your buddy list is #b50#k.");
			sendNext();
		else
			giveMesos(-price);
			addBuddySlots(5);
