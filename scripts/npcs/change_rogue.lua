...
if (getItemAmount(4031011) > 0 and getItemAmount(4031013) == 0) then	
	addText("Hmmm...it is definitely the letter from #b#p1052001##k...so you came all the way here to take ");
	addText("the test and make the 2nd job advancement as the rogue. Alright, I'll explain the test to you. ");
	...
	if yes == 0 then
		...
		addText("Alright! I'll let you in! Defeat the monster inside to earn 30 Dark Marble and then talk to my ");
		addText("colleague inside; he'll give you #b#t4031012##k as a proof that you've passed the test.");
		addText("Best of luck to you.");
		sendNext();
		setMap(108000401);
	end
elseif (getItemAmount(4031011) > 0 and getItemAmount(4031013) > 0) then
...
elseif (getJob() == 400 and getLevel() >= 30) then
	addText("Do you want to be a stronger thief? Let me take care of that for you, then. You look definitely ");
	addText("qualified for it. For now, go see #b#p1052001##k of Kerning City first.");
	sendNext();
end