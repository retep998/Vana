...
if getJob() == 0 then
	...
	addText("#b#L0##m104000000#(100 mesos)#l\r\n");
	addText("#L1##m102000000#(80 mesos)#l\r\n");
	addText("#L2##m101000000#(120 mesos)#l\r\n");
	addText("#L3##m100000000#(100 mesos)#l");
else
	addText("Choose your destination, for fees will change from place to place.\r\n");
	addText("#b#L0##m104000000#(1,000 mesos)#l\r\n");
	addText("#L1##m102000000#(800 mesos)#l\r\n");
	addText("#L2##m101000000#(1,200 mesos)#l\r\n");
