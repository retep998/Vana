...
--]]
-- A subset of Lua functions that helps with JSON serialization
			...
			if isArray then
				...
				for i = 1, maxKey do
					...
					if valueSerializer == nil then
						return serialize_err, "value of type " .. type(value) .. " has no valid serializer";
					end
				...
				for _, key in ipairs(stringKeys) do
					...
					if keySerializer == nil then
						return serialize_err, "key of type " .. type(key) .. " has no valid serializer";
					end
					if valueSerializer == nil then
						return serialize_err, "value of type " .. type(value) .. " has no valid serializer";
					end
